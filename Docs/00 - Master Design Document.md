...
**Version:** 0.7 - Phase 2C.3 observer result and vanilla-unowned audit guardrail documented (owner directive 2026-07-08); Automatic Province Development System (§6A) documented as a future economic simulation system (owner directive 2026-07-07); Culture-State World pivot applied (owner directive 2026-07-06); Personalized Borders foundation imported, validated, and locked
**Date:** 2026-07-08
**Status:** Approved rule set, pivoted to a fractured culture-state 1444 world (design pivot, not a restart — see §3A and [10 - Culture-State World Design](10%20-%20Culture-State%20World%20Design.md)); Iberia Phase 2A proof of concept implemented in history/decision/event files (see [12 - Iberia Culture-State POC Log](12%20-%20Iberia%20Culture-State%20POC%20Log.md)); post-crash Iberia observer reached 1489 without reproducing the crash (see [15 - Iberia Observer Test Log](15%20-%20Iberia%20Observer%20Test%20Log.md)); vanilla-unowned region audit completed with no non-Iberian Project Crown ownership overrides (see [16 - Vanilla Unowned Region Audit](16%20-%20Vanilla%20Unowned%20Region%20Audit.md)); no flags imported; Automatic Province Development documented as a **future** system (§6A) — design only, not implemented
...
- **Vanilla-unowned baseline:** Provinces that are unowned/uncolonized in vanilla EU4 remain unowned/uncolonized in Project Crown unless a later, explicit Project Crown design assigns them. Future clearing/open-region work must be driven by the vanilla ownership audit, not visual guessing ([16 - Vanilla Unowned Region Audit](16%20-%20Vanilla%20Unowned%20Region%20Audit.md)).
...
- **Audit-first open regions (owner rule 2026-07-08):** Tier B clearing/opening must preserve vanilla-unowned provinces by default and only clear vanilla-owned provinces after an approved exception list. North Africa is explicitly outside Sub-Saharan clearing. Asia remains generally populated, with the Philippines as the special mostly-uncolonized future exception.
